...
void selebor(float koor_x,float koor_y,float koor_z,float panjang,float lebar,float tinggi)
{
	...
	ban(30, 3, koor_x + (panjang / 1.8), koor_y, (koor_z + 1.25 * lebar)-2);
	ban(30, 3, koor_x + (panjang / 1.8), koor_y, (koor_z + lebar*1.25 + 30));
	Warna();
	ban(40, 30, koor_x + (panjang / 1.8), koor_y , (koor_z +1.25* lebar));
